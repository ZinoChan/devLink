...
export type GetUserLinksQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', email: string, first_name?: string | null, last_name?: string | null, profile_picture_url?: string | null }>, links: Array<{ __typename?: 'links', id: any, platform: string, url: string, display_order: number }> };
